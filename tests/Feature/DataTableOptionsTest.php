...
describe('DataTableOptions', function (): void {
    ...
    it('toggles column visibility and dispatches event', function (): void {
        Livewire::test(DataTableOptions::class, [
            'availableCols' => ['name', 'email', 'created_at'],
            'enabledCols' => ['name', 'email'],
        ])
    ...
    it('sets aggregation and dispatches event', function (): void {
        Livewire::test(DataTableOptions::class, [
    ...
    it('sets group by and dispatches event', function (): void {
        Livewire::test(DataTableOptions::class, [
